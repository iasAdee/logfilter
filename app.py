...
def process_200_images(image_bytes_list):
    ...
    for input image with index end with "02" and "03" get that middle numeric of length >=8 and <=10 number like in example from round bottle bottoms only
